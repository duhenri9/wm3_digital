      ...
      <div className="container">
        ...
        >
          ...
          <motion.span
            ...
            className="inline-flex items-center justify-center rounded-full border border-border/50 bg-accent/5 px-4 py-1.5 text-xs font-medium uppercase tracking-wider text-muted-foreground"
          >
            WM3 Digital
          </motion.span>
          ...
          {/* Subtitle */}
          <p className="mt-8 text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-normal">
